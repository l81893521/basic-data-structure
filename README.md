...
2. [使用数组实现队列](https://github.com/l81893521/basic-data-structure/blob/master/src/main/java/will/zhang/queue/ArrayQueue.java)
3. [循环队列](https://github.com/l81893521/basic-data-structure/blob/master/src/main/java/will/zhang/queue/LoopQueue.java)
4. [使用链表实现队列](https://github.com/l81893521/basic-data-structure/blob/master/src/main/java/will/zhang/queue/LinkedListQueue.java)
